(function ($) {
    Drupal.behaviors.evolve_myapps = {
        attach: function (context, settings) {
            ...
            $('.apigee-modal-link-delete a').click(function() {
                ...
                if (($(identifier + ' .modal-body #devconnect_developer_application_delete').length == 0)) {
                    ...
                    evolve_myappsPulsateForever(identifier + ' .modal-body .load-indicator');
                }
            ...
            function evolve_myappsPulsateForever(elem) {
                $(elem).fadeTo(500, 1.0);
                $(elem).fadeTo(500, 0.1, function() {
                    evolve_myappsPulsateForever(elem);
                });
            }
        }
    };
