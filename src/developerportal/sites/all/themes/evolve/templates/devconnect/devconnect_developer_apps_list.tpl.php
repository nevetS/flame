...
<?php if ($application_count): ?>
  ...
  <?php foreach ($applications as $app): ?>
    <?php $status = evolve_app_status($app); ?>
    <div class="panel-group my-apps" id="my-apps-accordion">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4 class="panel-title">
            ...
            <div class="status-label"><?php print _evolve_status_label_callback($status, TRUE); ?></div>
          </h4>
        </div>
                    ...
                    <table class="table" style="border:0;">
                      <tbody>
                        <tr>
                          ...
                          <td><?php print _evolve_status_label_callback($status); ?></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
